...
//TODO Troy, Is entrypoint-template.yaml used for both options? If so, how do I structure these two launch links? (Alternatively, it sounds like we may offer only the existing-VPC option?)